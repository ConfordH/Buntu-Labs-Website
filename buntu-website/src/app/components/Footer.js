        ...
        <div className="lg:flex lg:items-start lg:gap-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              ...
              <form className="w-full">
                <div className="relative max-w-lg">
                  ...
                  <input
                    ...
                    id="email"
                    type="email"
                    placeholder="sayhello@buntulabs.com"
                  />
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul style="list-style:none;" className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                ...
                <li>
                  <a
                    href="https://www.buntulabs.com/about-us"
                    className="transition hover:opacity-75 text-gray-200"
                  >
                    About Us
                  </a>
                ...
                <li>
                  <a
                    href="https://www.buntulabs.com/blog"
                    className="transition hover:opacity-75 text-gray-200"
                  >
                    Blogs
                  </a>
                ...
                <li>
                  <a
                    href="https://www.buntulabs.com/contact"
                    className="transition hover:opacity-75 text-gray-200"
                  >
                    Contact Us
                  </a>
                ...
                <li>
                  <a
                    href="https://www.buntulabs.com/write-for-us"
                    className="transition hover:opacity-75 text-gray-200"
                  >
                    Write For Us
                  </a>
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul style="list-style:none;" className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                    href="https://www.buntulabs.com/components"
                    className="transition hover:opacity-75 text-gray-200"
                  >
                    HTML, CSS, and JS
                  </a>
                ...
                <li>
                  <a
                    href="https://www.buntulabs.com/python-projects"
                    className="transition hover:opacity-75 text-gray-200"
                  >
                    Python
                  </a>
                ...
                <li>
                  <a
                    href="https://www.buntulabs.com/csharp-projects"
                    className="transition hover:opacity-75 text-gray-200"
                  >
                    C#
                  </a>
                ...
                <li>
                  <a
                    href="https://www.buntulabs.com/questions"
                    className="transition hover:opacity-75 text-gray-200"
                  >
                    Questions
                  </a>
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul style="list-style:none;" className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                    href="https://www.buntulabs.com/tools/case-converter"
                    className="transition hover:opacity-75 text-gray-200"
                  >
                    Case Converter
                  </a>
        ...
        <div className="mt-8 border-t pt-8 border-gray-800">
          <div className="sm:flex sm:justify-between">
            ...
            <ul className="mt-8 flex flex-wrap justify-start gap-4 text-xs sm:mt-0 lg:justify-end">
              <li>
                <a
                  href="https://www.buntulabs.com/terms-and-conditions"
              ...
              <li>
                <a
                  href="https://www.buntulabs.com/privacy-policy"
                  className="transition hover:opacity-75 text-gray-400"
                >
                  Privacy Policy
                </a>
